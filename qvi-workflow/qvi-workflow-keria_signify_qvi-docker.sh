#!/usr/bin/env bash
# qvi-workflow-keria_signify_qvi-docker.sh
...
#
# Note:
# Runs the entire workflow in a Docker Compose environment and uses KERIA with SignifyTS for the QVI multisig and Person identities.
# This script starts up and tears down the necessary Docker Compose environment.

# WARNING: WORK IN PROGRESS, NOT COMPLETE
# WARNING: WORK IN PROGRESS, NOT COMPLETE
# WARNING: WORK IN PROGRESS, NOT COMPLETE
# WARNING: WORK IN PROGRESS, NOT COMPLETE
# WARNING: WORK IN PROGRESS, NOT COMPLETE
...
echo
print_bg_blue "------------------------------vLEI QVI Workflow Script (KERIA & SignifyTS in Docker)------------------------------"
echo
...
tsx "$(dirname "$0")/signify_qvi/qvi-steps.ts" $QAR_PT1
cleanup
exit 0
