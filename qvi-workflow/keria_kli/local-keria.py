#!/usr/bin/env python3
"""Run KERIA with workflow-owned persistent storage."""
...
from keria.app.cli import keria


def main() -> None:
    """Set the isolated storage root, then hand control to KERIA."""
